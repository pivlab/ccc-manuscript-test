...
For most cases (76.4%), an UpSet analysis showed that the three coefficients agreed on whether there is a strong correlation (42.1%) or there is no relationship (34.3%).
...
While there was broad agreement, more than 20,000 gene pairs with a high correlation coefficient value were not highly ranked by the other coefficients (right part of Figure @fig:upsetplot_coefs a).
There were also gene pairs with a high Pearson value and either low correlation coefficient (CCC) (1,075), low Spearman (87), or both low CCC and low Spearman values (531).
